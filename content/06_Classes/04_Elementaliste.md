...
- **Air** est l'élément du Déplacement. Les aptitudes d'Air vous permettent de manipuler la Vitesse, la rapidité, le vol et le souffle.
...
De plus, comme activité de répit, vous pouvez effectuer un rituel qui fait jaillir du sol un arbre fruitier, le fait grandir, mûrir et produire 1d6 d'un trésor appelé Fruit de Vie. Vous pouvez utiliser une activité de répit pour faire qu'un arbre existant produise 1d6 Fruits de Vie supplémentaires, mais il ne fait pas pousser ces consommables magiques par lui-même.
